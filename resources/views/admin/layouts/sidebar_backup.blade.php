<!-- This is a backup copy of the sidebar file -->
<!-- If the original sidebar.blade.php is deleted, you can copy this file to restore it -->
...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items {{ request()->routeIs('admin.corona') ? 'active' : '' }}">
